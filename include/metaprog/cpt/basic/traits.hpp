...
#ifndef METAPROG_CPT_BASIC_TRAITS_HPP_
#define METAPROG_CPT_BASIC_TRAITS_HPP_

#include <type_traits>

namespace cpt::traits::basic {
...
template <typename T>
using is_nothrow_default_constructible_t = typename is_nothrow_default_constructible<T>::type;
...
template <typename T>
using is_nothrow_move_constructible_t = typename is_nothrow_move_constructible<T>::type;

using std::is_trivially_move_constructible;
using std::is_trivially_move_constructible_v;
template <typename T>
using is_trivially_move_constructible_t = typename is_trivially_move_constructible<T>::type;
...
template <typename T>
using is_trivially_move_assignable_t = typename is_trivially_move_assignable<T>::type;
...
template <typename T>
using is_nothrow_copy_constructible_t = typename is_nothrow_copy_constructible<T>::type;

using std::is_trivially_copy_constructible;
using std::is_trivially_copy_constructible_v;
template <typename T>
using is_trivially_copy_constructible_t = typename is_trivially_copy_constructible<T>::type;
...
template <typename T>
using is_trivially_destructible_t = typename is_trivially_destructible<T>::type;

} // namespace cpt::traits::basic

#endif // METAPROG_CPT_CONCEPTS_BASIC_TRAITS_HPP_
