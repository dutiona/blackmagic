...
#ifndef CONCEPTS_ITERATOR_CONCEPTS_HPP_
#define CONCEPTS_ITERATOR_CONCEPTS_HPP_
...
namespace concepts { namespace iterator {


}} // namespace concepts::iterator

#endif // CONCEPTS_ITERATOR_CONCEPTS_HPP_
