...
using is_detected = typename detector<nonesuch, Op, type::basic_type_list<Args...>>::value_t;

template <template <typename...> class Op, typename... Args>
using detected_t = _t<detector<nonesuch, Op, type::basic_type_list<Args...>>>;

template <typename Default, template <typename...> class Op, typename... Args>
using detected_or = detector<Default, Op, type::basic_type_list<Args...>>;
