...
TEST(Functional_ReversePartial, Function)
{
  ASSERT_TRUE(functional::reverse_partial(func_test, 1, 2)(4, 5) == 12);
}
...
TEST(Functional_Partial, Lambda)
{
  ...
  ASSERT_TRUE(functional::reverse_partial(lmbd, 1, 2)(4, 5) == 12);
}
...
{
  ASSERT_TRUE(functional::reverse_partial(functor{}, 1, 2)(4, 5) == 12);
}
