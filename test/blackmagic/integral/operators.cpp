...
using namespace integral::operators;
...
TEST(Integral_Operators, Arithmetic_Positive)
{
  ...
  static_assert(std::is_same_v<decltype(+1_c), decltype(1_c)>);
  static_assert((+1_c) == 1_c);
  static_assert(std::is_same_v<decltype(+1_c), decltype(1_c)>);
}
...
TEST(Integral_Operators, Arithmetic_Plus)
{
  ...
  static_assert(std::is_same_v<decltype(1_c + 1_c), decltype(2_c)>);
  static_assert((1_c + (-1_c)) == 0_c);
  static_assert(std::is_same_v<decltype(1_c + (-1_c)), decltype(0_c)>);
}
...
TEST(Integral_Operators, Comparison_EqualTo)
{
  ...
  static_assert(std::is_same_v<decltype("true"_bc), decltype("true"_bc)>);
  static_assert("false"_bc == "false"_bc);
  static_assert(std::is_same_v<decltype("false"_bc), decltype("false"_bc)>);
}

TEST(Integral_Operators, Comparison_NotEqualTo)
{
  static_assert(1_c != 2_c);
  static_assert(std::is_same_v<decltype(1_c != 2_c), decltype("true"_bc)>);
  static_assert("false"_bc != "true"_bc);
  static_assert(std::is_same_v<decltype("false"_bc != "true"_bc), decltype("true"_bc)>);
}
...
TEST(Integral_Operators, Comparison_LessThan)
{
  ...
  static_assert(std::is_same_v<decltype(1_c < 2_c), decltype("true"_bc)>);
  static_assert(!(1_c < 1_c));
  static_assert(std::is_same_v<decltype(!(1_c < 1_c)), decltype("true"_bc)>);
}
...
TEST(Integral_Operators, Comparison_GreaterThan)
{
  ...
  static_assert(std::is_same_v<decltype(2_c > 1_c), decltype("true"_bc)>);
  static_assert(!(1_c > 1_c));
  static_assert(std::is_same_v<decltype(!(1_c > 1_c)), decltype("true"_bc)>);
}
...
TEST(Integral_Operators, Logical_Not)
{
  static_assert((!"false"_bc) == "true"_bc);
  static_assert((!"false"_bc) != "false"_bc);
  static_assert(std::is_same_v<decltype(!"false"_bc), decltype("true"_bc)>);
  static_assert((!"true"_bc) == "false"_bc);
  static_assert((!"true"_bc) != "true"_bc);
  static_assert(std::is_same_v<decltype(!"true"_bc), decltype("false"_bc)>);
}

TEST(Integral_Operators, Logical_And)
{
  static_assert(("true"_bc && "false"_bc) == "false"_bc);
  static_assert(std::is_same_v<decltype("true"_bc && "false"_bc), decltype("false"_bc)>);
  static_assert(("false"_bc && "true"_bc) == "false"_bc);
  static_assert(std::is_same_v<decltype("false"_bc && "true"_bc), decltype("false"_bc)>);
  static_assert(("true"_bc && "true"_bc) == "true"_bc);
  static_assert(std::is_same_v<decltype("true"_bc && "true"_bc), decltype("true"_bc)>);
  static_assert(("false"_bc && "false"_bc) == "false"_bc);
  static_assert(std::is_same_v<decltype("false"_bc && "false"_bc), decltype("false"_bc)>);
}

TEST(Integral_Operators, Logical_Or)
{
  static_assert(("true"_bc || "false"_bc) == "true"_bc);
  static_assert(std::is_same_v<decltype("true"_bc || "false"_bc), decltype("true"_bc)>);
