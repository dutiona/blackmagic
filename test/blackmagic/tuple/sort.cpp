...
{
  ASSERT_TRUE(tuple::equal(tuple::sort(std::less<>{}, std::make_tuple(20, 8, 15, 7, 3, 1, 1, 2, 8, 5, 4, 6)),
                           std::make_tuple(1, 1, 2, 3, 4, 5, 6, 7, 8, 8, 15, 20)));
}

TEST(Tuple_Sort, SimpleGreater)
{
  ASSERT_TRUE(tuple::equal(tuple::sort(std::greater<>{}, std::make_tuple(20, 8, 15, 7, 3, 1, 1, 2, 8, 5, 4, 6)),
